...
import com.prtcdemo.view.BaseSwitch;
import com.prtcdemo.view.LSwitch;
...
public class NewSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBroadcastSwitch.setOnCheckedListener(new BaseSwitch.OnCheckedListener() {
            @Override
            public void onChecked(boolean isChecked) {
                mRoomType = isChecked ? PRTCChannelProfile.ROOM_LARGE : PRTCChannelProfile.ROOM_SMALL;
        ...
        mBroadcastSwitch.setChecked(mRoomType == PRTCChannelProfile.ROOM_LARGE);
