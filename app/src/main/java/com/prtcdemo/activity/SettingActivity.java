...
import com.prtcdemo.utils.RadioGroupFlow;
...
import static core.define.CoreConstants.SdkMode.MODE_NORMAL;
...
public class SettingActivity extends AppCompatActivity {
    ...
    private PRTCClientRole mRole;
    private PRTCChannelProfile mRoomType;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(userId)){
                    ...
                    PRTCApplication.setUserId(userId);
                }
        ...
        int roleInt = preferences.getInt(CommonUtils.SDK_STREAM_ROLE, PRTCClientRole.CLIENT_ROLE_BROADCASTER.ordinal());
        mRole = PRTCClientRole.valueOf(roleInt);
        switch (mRole) {
        ...
        int roomInt = preferences.getInt(CommonUtils.SDK_CLASS_TYPE, PRTCChannelProfile.ROOM_SMALL.ordinal());
        mRoomType = PRTCChannelProfile.valueOf(roomInt);
        switch (mRoomType) {
            case ROOM_SMALL:
        ...
        if (PRTCEnvHelper.getSdkMode() == MODE_TRIAL) {
        ...
        mEnvGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (group.getCheckedRadioButtonId()) {
                    case R.id.dev_env:
                        PRTCEnvHelper.setSdkMode(MODE_NORMAL);
                        break;
                    case R.id.test_env:
                        PRTCEnvHelper.setSdkMode(MODE_TRIAL);
                        break;
                }
            }
        });
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (group.getCheckedRadioButtonId()) {
                    ...
                    case R.id.rb_role_scribe:
                        mRole = PRTCClientRole.CLIENT_ROLE_AUDIENCE;
                        break;
                    case R.id.rb_role_both:
                        mRole = PRTCClientRole.CLIENT_ROLE_BROADCASTER;
//                    if (mRoomType == PRTCChannelProfile.ROOM_LARGE) {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (group.getCheckedRadioButtonId()) {
                    case R.id.rb_type_small_room:
                        mRoomType = PRTCChannelProfile.ROOM_SMALL;
                        mRBRoleBoth.setEnabled(true);
                        break;
                    case R.id.rb_type_large_room:
                        mRoomType = PRTCChannelProfile.ROOM_LARGE;
                        mRBRoleBoth.setEnabled(true);
                        checkRole();
                        break;
                }
...
//        textView.setText(LogReportManager.logPre ? "pre" : "online");
//        textView.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if (LogReportManager.logPre) {
//                    LogReportManager.logPre = false;
//                } else {
//                    LogReportManager.logPre = true;
//                }
//                LogReportManager.refreshUrl();
//                textView.setText(LogReportManager.logPre ? "pre" : "online");
//            }
//        });
        if(!TextUtils.isEmpty(PRTCApplication.getUserId())){
            mUserIdEditText.setText(PRTCApplication.getUserId());
        }
    }
    ...
    private void checkRole() {
        if (mRole == PRTCClientRole.CLIENT_ROLE_BROADCASTER) {
