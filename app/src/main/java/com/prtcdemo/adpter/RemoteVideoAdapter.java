    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (holderView.getChildCount() == 0) {
            ...
            if (render != null && render instanceof View) {
                ...
                if(videoView instanceof PRTCSurfaceViewGroup){
                    ((PRTCSurfaceViewGroup)videoView).setZOrderMediaOverlay(true);
                    videoView.setTag(R.id.render,((PRTCSurfaceViewGroup)videoView).getSurfaceView());
                }
                else if(videoView instanceof PRTCSurfaceViewRenderer){
                    ((PRTCSurfaceViewRenderer)videoView).setZOrderMediaOverlay(true);
...
//                videoView.setTag(R.id.index, viewInfo);
    ...
    public void updateSwapInfo(PRTCStreamInfo clickInfo, PRTCStreamInfo swapInfo){
        ...
        RTCVideoViewInfo click = mStreamViews.remove(clickKey);
    ...
    public void addStreamView(String mkey, RTCVideoViewInfo videoView, PRTCStreamInfo streamInfo) {
